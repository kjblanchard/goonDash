...
function KeyboardFunctions.DebugSdlToBoundButtons(sdlkey)
...
function KeyboardFunctions.AddKeyPressToQueue(sdlkey, isKeyDown)
    local keybind = ControllerBindings[sdlkey]
    if keybind == nil then return end
    local keyEvent = {}
...
KeyboardFunctions.ControllerQueue = {}
