...
econfigure:
	@emcmake cmake . -B build -D CMAKE_BUILD_TYPE=Debug -G $(BACKUP_BUILD_SYSTEM) -DGOON_FULL_MACOS_BUILD=ON -DCMAKE_VERBOSE_MAKEFILE=ON -Dvendored_default=FALSE -DSDL2TTF_VENDORED=FALSE
# Macos Runner
mconfigure:
